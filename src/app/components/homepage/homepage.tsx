        ...
        <section className="pt-20">
                ...
                <div className="pt-24">
                    ...
                    <div className="pb-[7rem] flex items-start largeTablet:flex-col smallTablet:flex-col mobile:flex-col largeTablet:space-y-6 smallTablet:space-y-6">
                        <div className="w-[60%] pr-4 mobile:w-[100%] mobile:pb-6">
                            ...
                            <p className="text-lg pt-3">Manage your tasks effortlessly with TaskMaster`&apos;s lists. From start to finish, organize your workflow with stages like To-Do, In Progress, and Completed.</p>
                        </div>
                    ...
                    <div className="flex items-start largeTablet:flex-col-reverse smallTablet:flex-col-reverse mobile:flex-col largeTablet:space-y-6 smallTablet:space-y-6">
                        ...
                        <div className="w-[60%] pl-4 mobile:w-[100%] largeTablet:pb-6 largeTablet:pl-0 smallTablet:pb-6 smallTablet:pl-0">
                            ...
                            <p className="text-lg pt-3">Make tasks a breeze with TaskMaster boards. Stay on top of everything and get a clear picture of tasks from start to finish.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="flex flex-col items-center">
                    <div className="flex flex-col largeTablet:">
                        ...
                        <div className="pt-4 flex justify-center">
                            <p className="text-center text-lg w-[70%]">Empower your productivity with TaskMaster&apos;s goal-setting feature. Effortlessly track your goals, gain insights, and celebrate achievements. </p>
                        </div>
                    </div>
            ...
            <div className="bg-white px-[8%] py-[6rem]">
                <div className="flex flex-col items-center">
                    ...
                    <p className="pt-3 text-lg">Try TaskMaster for free. Boost your productivity with easy task management.</p>
                    <div className="pt-4">
                        <Link href="/login">
